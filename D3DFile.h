...
public:
    ...
    VOID    SetName( TCHAR* strName )     { strcpy_s((char*)m_strName, 80, (const char*)strName ); }
	...
	VOID    SetMeshMaterialData( DWORD* wList );
    BOOL EnumObjects(BOOL(*fnCallback)(CD3DFileObject*, D3DMATRIX*, VOID*), D3DMATRIX* pmat, VOID* pContext);
...
public:
    ...
    HRESULT Load( TCHAR* strFilename, LPDIRECT3DRMFRAME3 f, LPDIRECT3DRM3 rm3, LPDIRECT3DRMMESHBUILDER3 mb );
