...
AppWizard has created this RotoDraw3D application for you.  This application
not only demonstrates the basics of using the Microsoft Foundation classes
but is also a starting point for writing your application.

This file contains a summary of what you will find in each of the files that
make up your RotoDraw3D application.
...
RotoDraw3D.h
    ...
    CRotoDraw3DApp application class.

RotoDraw3D.cpp
    This is the main application source file that contains the application
    class CRotoDraw3DApp.
...
res\RotoDraw3D.ico
    ...
    icon is included by the main resource file RotoDraw3D.rc.
...
RotoDraw3DDlg.h, RotoDraw3DDlg.cpp - the dialog
    These files contain your CRotoDraw3DDlg class.  This class defines
    the behavior of your application's main dialog.  The dialog's
    template is in RotoDraw3D.rc, which can be edited in Microsoft
	Visual C++.
...
StdAfx.h, StdAfx.cpp
    ...
    named RotoDraw3D.pch and a precompiled types file named StdAfx.obj.
